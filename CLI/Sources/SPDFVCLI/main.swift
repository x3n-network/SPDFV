...
private struct OperationReport: Encodable {
...
private struct AnnotationListReport: Encodable {
    let input: String
    let pages: [Int]
    let count: Int
...
private struct OCROperationReport: Encodable {
    let operation: String
    let input: String
    let output: String
...
private struct TextPageReport: Encodable {
    let page: Int
    let characters: Int
    let text: String
}

private struct TextExtractionReport: Encodable {
    let input: String
    let pages: [Int]
    let characters: Int
...
private struct RedactionOperationReport: Encodable {
    let operation: String
    let input: String
    let output: String
...
private struct FormInspectionReport: Encodable {
    let input: String
    let report: PDFFormReport
}

private struct FormGateInspectionReport: Encodable {
    let input: String
...
private struct FormAuthoringOperationReport: Encodable {
    let operation: String
    let input: String
    let output: String
    let page: Int
...
private struct FormRenameOperationReport: Encodable {
    let operation: String
    let input: String
    let output: String
...
private struct RecipeOperationReport: Encodable {
    let operation: String
    let input: String
    let recipe: String
    let output: String?
...
private struct BatchRecipeOperationReport: Encodable {
    let operation: String
...
private struct RecipeLibraryOperationReport: Encodable {
    let operation: String
    let library: String
    let count: Int
...
private struct RecipeQueueOperationReport: Encodable {
    let operation: String
    let queue: String
...
private struct RecipeWatchState: Codable {
    let version: Int
...
private struct RecipeWatchItemReport: Encodable {
    let input: String
    let output: String
    let status: String
    let error: String?
...
private struct RecipeWatchOperationReport: Encodable {
    let operation: String
    let inputDirectory: String
    let outputDirectory: String
    let recipe: String
...
private func encode<T: Encodable>(_ value: T, pretty: Bool) throws -> String {
...
private func decodeFile<T: Decodable>(_ type: T.Type, at url: URL) throws -> T {
...
private func selectedPages(_ parser: OptionParser, document: PDFDocument) throws -> [Int] {
...
private func parseRedactionRegions(_ value: String) throws -> [PDFRedactionRegion] {
...
private func parseInsets(_ value: String) throws -> PDFEdgeInsets {
